...
#     $textBoxPattern1 = $form.Controls | Where-Object { 'pattern1' -eq $_.Name }
#     $textBoxPattern2 = $form.Controls | Where-Object { 'pattern2' -eq $_.Name }
#     $textBoxEncoding = $form.Controls | Where-Object { 'encoding' -eq $_.Name }
#     $button = $form.Controls | Where-Object { 'button' -eq $_.Name }
# }
